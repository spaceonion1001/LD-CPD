...
def main_sims_avesnov(): # changes the window calculations because it slides both of them
    ...
    for curr_dim in dims:
        ...
        for sim_type in sim_types:
            ...
            plt.plot(thresholds_ours, means_per_threshold_ours, color='blue', linestyle='-.', label='Ours', linewidth=2.5)
...
def main_sims():
    ...
    #                                                                  )
            ...
            print("Plotting")
            plt.figure(figsize=(15, 12))
            plt.plot(thresholds_ours, means_per_threshold_ours, '.b-', label='Ours', linewidth=5)
